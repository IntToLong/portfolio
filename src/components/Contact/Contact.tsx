...
export default function Contact() {
	return (
		<section
			id='contact'
			className='px-4 sm:px-6 md:px-20 lg:px-28 md:my-20 my-10'>
			...
			<div className='md:flex md:flex-row-reverse gap-28 md:items-center'>
				<div className='flex flex-col gap-8 my-8 w-full'>
					<h2 className='font-extrabold text-[28px]/[114%] tracking-tight md:text-5xl/[117%]'>
						Let`s
