...
export const linksInfo: NavLink[] = [
...
export const projectsData: ProjectType[] = [
  {
    ...
    description:
      "This project is a lightweight Chrome extension that instantly converts text typed in the wrong keyboard layout (English → Ukrainian) without needing to delete or retype. It eliminates the need to delete and retype text by allowing users to simply highlight the text and click to convert it. The extension is designed to be simple, fast, and hassle-free, with features that let you either copy the corrected text to the clipboard or replace it in place.",
    ...
    ariaLabel: {
      demo: "View Ukrify live demo",
      github: "View Ukrify project source code on GitHub"
    }
  },
  {
